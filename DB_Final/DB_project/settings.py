...
SECRET_KEY = 'django-insecure-^sx5$spiq*4sfgt2l)skl%@1cqn$f21)d0pf*#-@qpq#=8ggb9'
...
# STATIC_URL = 'static/'
STATIC_URL = '/static/'  # URL 前綴，用於靜態文件的訪問

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # 確保使用 os.path.join
]
